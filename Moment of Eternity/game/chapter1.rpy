...
label follow:
    ...
    hide enji_siding
    enj "Ах... Но всё же."
    show enji_smilling_down with fastdissolve
    hide enji_thinking
    pause(1.0)
    hide enji_smilling_down with fastdissolve
    ...
    show enji_evil_smilling with averagedissolve
    ...
    show natali_smilling with fastdissolve
    hide natali_usual
    ...
    show natali_smilling with averagedissolve
    hide natali_usual
