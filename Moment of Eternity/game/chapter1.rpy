...
label follow:
    ...
    hide enji_thinking
    "Какое-то время мы с Энджи сидели, нахмурив брови, ничего не обсуждая."
    "..."
    enj "Кхмм... Кхммм..."
    "Через несколько минут я услышал от неё странное покашливание, и мне показалось, что так она хочет привлечь к себе внимание."
    ...
    hide enji_thinking
    pause(1.0)
    hide enji_smilling_down with fade
    ...
    me "Эй!"
    scene sleep_district_evening with averagedissolve
    pause(0.5)
    ...
    me "Я думаю, ты слишком нервно воспринимаешь то, что происходит вокруг тебя. Нет. Не совсем.., если правильнее выразиться..."
    show enji_siding with averagedissolve
    hide enji_upset
    ...
    hide enji_siding
    enj "Возможно."
    hide enji_speaking_down with fading
    "Она ответила спокойно, но тот факт, что она не смотрела на меня, значил, что ей было неинтересно."
    "Возможно, я всё-таки некорректно выразил свои мысли."
    "Или вовсе не угадал."
    "В любом случае, это была лишь моя попытка узнать Энджи получше, и пыткой это не было."
    "Я думал об этом, наблюдая, как Энджи развернулась, вытащила из кармана неприметный телефон и отдалилась на несколько метров уверенным быстрым шагом."
