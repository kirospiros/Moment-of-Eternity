...
define config.name = _("Moment Of Eternity")
...
define gui.about = _p("""Created not for sale. For non-commercial use. With Love by SoloEvade.
""")
...
define build.name = "MomentOfEternity"
...
define config.save_directory = "MomentofEternity-1605650994"
