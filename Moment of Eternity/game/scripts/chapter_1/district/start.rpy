label chapter_1_district_the_walk:
    ...
    "Эххх..."
    "Вспоминая утро прошедшего дня, я никак не мог не сравнить шум и суету спального района мегаполиса и спокойствие моего дома."
    ...
    "Достаточно побродив в окрестностях, и, чувствуя небольшое утомление, я случайно обнаружил себя во дворе."
    ...
    "Посидев немного, я решил что-нибудь купить, чтобы промочить горло, да и захотелось почувствовать какой-то вкус жизни."
    "Или лишь его имитацию... Сейчас я был в настроении получить простое краткосрочное наслаждение."
    ...
    "Амбивалентное чувство, на самом деле..."
    ...
    "Возможно, что от полированного металла отразился свет, а дальше вода в пластиковой бутылке также частично осветила его, и луч слегка задел мой глаз."
    "..."
...
label chapter_1_waterbottle_stranger:
    ...
    "она выхватила бутылку с водой из моей расслабленной руки"
...
label chapter_1_call_to_key:
    ...
    "Не желая больше об этом думать, я резко провел ладонью по лбу, взъерошив челку, чтобы собраться с мыслями."
...
label chapter_1_soda_drinking:
    ...
    "Несмотря на то, что у меня не было никаких проблем с запоминанием местности, я всё же с трудом находил обратную дорогу, ведь спальный район был усеян похожими друг на друга двухэтажными домишками."
...
label chapter_1_district_enji_meeting:
    ...
    "Хотя я всё еще не пришел в себя, и наверное, лучше бы следовало вернуться домой пораньше и извиниться перед Филом за то, что я погорячился..."
    "И тогда я решил-"
