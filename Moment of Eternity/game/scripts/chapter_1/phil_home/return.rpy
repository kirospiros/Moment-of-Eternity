label chapter_1_return_home:
    ...
    # Глава 1: Вечер - Дом Фила - Снова обычный вечер.
    # Chapter 1: Evening - Phil's House - Another usual evening.
    ...
    "Я тихо открыл входную дверь, разулся, пересек кухню и вошел в его комнату."
    ...
    "В качестве извинения я хотел помочь ему с уборкой, но, кажется, Фил недавно закончил: вид у него был усталый."
...
label chapter_1_watching_tv:
    ...
    "Но самое интересное случилось в кульминации: парень, отказавшись от всех будущих невзгод, завязал с клубом."
    ...
    "Возможно, это как раз то, о чем вскользь также упоминала Энджи."
