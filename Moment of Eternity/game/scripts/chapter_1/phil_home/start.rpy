label phil_home_start:
    ...
    # Chapter 1: Morning - Phil's House - Recovering.
...
label chapter_1_phil_morning_conversation:
    ...
    "Скорее всего, я просто оказался здесь по несчастливой случайности, а он начал рассказывать какие-то нелепые вещи со серьёзным лицом."
