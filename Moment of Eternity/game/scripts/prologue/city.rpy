label prologue_city_train_station:
    ...
    "Въезжая в город, поезд уже нигде не останавливался и помчался к центральной станции, петляя по всяким тоннелям и мостам."
    "Время - полдесятого, но я уже давно смирился с тем, что опоздал, ведь официально мой рабочий день начинается в девять..."

    me "\"Мне следует искренне извиниться, когда его увижу...\" "
...
label prologue_city_main_station_norm:
    ...
    "Что ж, мне в любом случае придется сегодня извиняться..."
...
label prologue_city_about_key_car:
    ...
    "Мелкими приятными деталями, пожалуй, являются: новейшая система автовождения, улучшенная система безопасности, гибкое и аэродинамическое построение корпуса авто."
